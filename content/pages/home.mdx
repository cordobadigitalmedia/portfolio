...
blocks:
  ...
  - cardblock:
      - headline: IANA Financial Website
        coverimage: /media/Screenshot 2025-01-01 at 10.52.02 AM.png
        content: >
          Website migration from Wordpress to static site for better SEO and
          speed


          * Apply for loan with fields editable by content manager

          * Custom resources section
        links:
          - link: 'https://www.ianafinancial.org/'
            label: Visit SIte
            style: button
      - headline: Psychological Services Website
        coverimage: /media/Screenshot 2025-01-01 at 9.58.15 AM.png
        content: |
          Website migration from Wordpress to make it easy to manage
